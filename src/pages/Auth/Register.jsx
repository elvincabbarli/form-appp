...
const Register = () => {
  ...
  return (
    <div className="main-registr-div">
      <div className="registr-right">
        <div className="registr-blur">
          <p>Need webdesign for your business? DİPNOTE will help you.</p>
        </div>
      </div>
          ...
          <form className="form-container" onSubmit={handleSubmit}>
            ...
            <div style={{ display: "flex", gap: "15px" }}>
              <label htmlFor="getEmail">
                Mən e-poçt vasitəsilə bildirimləri <br /> və yeniləmələr almaq
                istəyirəm.
              </label>
              <input
                type="checkbox"
